                ...
                def give_access_task():
                    try:
                        ...
                        prompt = (f"Go to https://techpathai.learnyst.com/admin and log in using the following credentials: "
                                  ...
                                  f"Locate the search bar labelled 'Search by Email (alt+k)' , which is positioned directly beneath the 'All Learners' heading to find the learner with the email '{email}' and hit the 'Search' button. "
